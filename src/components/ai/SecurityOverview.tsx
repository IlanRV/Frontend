...
import type { ExtractionResponse, RunnabilityBlockerSeverity, RunnabilityResult, RuntimeSecuritySummary, SandboxSecurityEvent, SecurityFinding, SecuritySeverity } from "@/types";
...
export function SecurityOverview({ extraction, runnability, runtimeEvents = [], runtimeSecurity, isLoading, error, onRetry }: SecurityOverviewProps) {
